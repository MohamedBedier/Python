...
class Member:
  ...
  def __init__(self):## this is a method that will be called every time we create an object from the class
    print("A New Member Has Been Added")

""" when we create an object from the class python look for the built in __init__ method  
    and call it and print the message """
member_one = Member()

member_two = Member()

member_three = Member()
### if you want to know the class of the object you can use the __class__ attribute
